...
%% Provides gb4e-like environments for use in inline lists.
...
%%   inxlistI  I. II. III.   (mirrors xlistI)
%%
%% Helper macro: \displayex
%%   Use it to wrap an inexe environment inside inline lists 
%%   (e.g., inparaenum) to maintain proper display-math spacing.
